...
if __name__ == '__main__':
	...
	fields = list(demographics.columns.values)
	for i,field in enumerate(fields):
		print i,field
	demographics = numpy.array(demographics)
	...
	for i,outline in enumerate(outlines):
		...
		colors.append(demographics[i,indexer])
	...
	p = PatchCollection(patches, edgecolor='none',alpha=1.0,cmap=plt.get_cmap('hot'),norm=mpl.colors.Normalize(vmin=0.0, vmax=100))
