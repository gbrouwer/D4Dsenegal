...
if __name__ == '__main__':
	...
	#Parse Data
	population,gender,dept,deptid,year,area = parseData('populations.csv')
	...
	#Store
	with open('population_plus.csv','w') as f:
		for i in range(123):
			for m in range(7,8):
				val0 = P[i,2,0,-1]
				val1 = P[i,2,1,-1]
				val2 = P[i,2,2,-1]
				f.write(str(i) + ',' + str(int(val0)) + ',' + str(int(val1)) + ',' + str(int(val2)) + '\n')
