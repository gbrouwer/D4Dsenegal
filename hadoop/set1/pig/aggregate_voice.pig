...
---
--- --------------------------------------------------------------------------------------------------------------------------------------------
RMF d4d/set1/voice_total;
RMF d4d/set1/voice_weekday;
RMF d4d/set1/voice_month;
RMF d4d/set1/voice_hour;
RMF d4d/set1/voice_week;
--- --------------------------------------------------------------------------------------------------------------------------------------------
...
--- 
--- --------------------------------------------------------------------------------------------------------------------------------------------
data = LOAD '/user/gijs/d4d/set1/voice' USING PigStorage(',') AS (timestamp:chararray, outgoing: int, incoming: int, nCalls: int, totDuration: int);
--- --------------------------------------------------------------------------------------------------------------------------------------------
...
total = FOREACH (GROUP data BY (outgoing,incoming)) GENERATE
	group AS C,
	SUM(data.nCalls) AS nCalls,
	SUM(data.totDuration) AS totDuration;
--- --------------------------------------------------------------------------------------------------------------------------------------------
...
---
--- --------------------------------------------------------------------------------------------------------------------------------------------
STORE total INTO 'd4d/set1/voice_total' USING PigStorage('\t', '-schema');
STORE month INTO 'd4d/set1/voice_month' USING PigStorage('\t', '-schema');
STORE week INTO 'd4d/set1/voice_week' USING PigStorage('\t', '-schema');
STORE hour INTO 'd4d/set1/voice_hour' USING PigStorage('\t', '-schema');
STORE weekday INTO 'd4d/set1/voice_weekday' USING PigStorage('\t', '-schema');
--- --------------------------------------------------------------------------------------------------------------------------------------------
